...
export const quizApi = {
  ...
  addFeedback: (attemptId, data) =>
    api.post(`/test/submissions/${attemptId}/feedback`, data),
  getPending: (page = 0, size = 10) =>
    api.get('/test/pending', { params: { page, size } }),
